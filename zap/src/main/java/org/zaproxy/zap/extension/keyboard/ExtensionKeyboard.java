...
public class ExtensionKeyboard extends ExtensionAdaptor {
     ...
     * @since 2.18.0
     */
    public void registerAcceleratorChangeListener(
            String identifier, Consumer<KeyStroke> listener) {
    ...
    private void addAllActions(List<KeyboardShortcut> kss, boolean reset) {
        ...
        actions.sort(Comparator.comparing(KeyboardMapping::getName, Comparator.nullsLast(String::compareTo)));
