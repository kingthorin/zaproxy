...
public class Scanner implements Runnable {
    ...
    public java.util.Date getTimeStarted() {
        ...
        return new java.util.Date(System.currentTimeMillis() - elapsedMillis);
    }
    ...
    public java.util.Date getTimeFinished() {
        ...
        java.util.Date started = getTimeStarted();
        if (started == null) {
            return null;
        }
        long elapsedMillis = getElapsedMillis();
        return new java.util.Date(started.getTime() + elapsedMillis);
    }
